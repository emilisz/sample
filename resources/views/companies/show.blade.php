...
<div class="container jumbotron">
    <div class="row">
        <div class="col-4">
    <img class="img-thumbnail" width="60%" src="{{url('storage/logos/'.$company->logo)}}">
...
<form action="{{route('companies.employees.create', $company)}}" method="get">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <form  method="POST" action="{{route('companies.employees.destroy', ['ide'=> $company->id,'id'=> $employee->id])}}">
            {!! method_field('delete') !!}
            @csrf
